...
{
    resize(850, 550);
    setWindowTitle(tr("OriginBlockChain") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
  ...
  //  frameBlocksLayout->addStretch();
   ...
   /* if (GetBoolArg("-staking", true))
    ...
    // as they make the text unreadable (workaround for issue 071)
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a OriginBlockChain address"));
    ...
    //aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About OriginBlockChain"), this);
   // aboutAction->setToolTip(tr("Show information about OriginBlockChain"));
   // aboutAction->setMenuRole(QAction::AboutRole);
   // aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
   // aboutQtAction->setToolTip(tr("Show information about Qt"));
   // aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for OriginBlockChain"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("OriginBlockChain client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("OriginBlockChain client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to OriginBlockChain network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid OriginBlockChain address or malformed URI parameters."));
    }
